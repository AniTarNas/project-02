...
@Component({
  selector: 'app-levels02test',
  templateUrl: './levels02test.component.html',
  styleUrls: ['./levels02test.component.css']
})
export class Levels02testComponent implements OnInit {
  ...
  ngOnInit() {
    this.testsService.getTest02().subscribe((test: Test[]) => {
      this.test = test;
    });
  ...
  onSubmit(form: NgForm) {
    ...
    if (this.myNumber >= 5) {
      ...
      this.activeUser.level = 3;
      this.activeUser.level03 = true;

...
@Component({
  selector: 'app-levels01info',
  templateUrl: './levels01info.component.html',
  styleUrls: ['./levels01info.component.css']
})
export class Levels01infoComponent implements OnInit {
